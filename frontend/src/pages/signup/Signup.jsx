  ...
  return (
    <div className="flex flex-col items-center justify-center min-w-96 mx-auto">
        ...
        <h1 className="text-3xl font-semibold text-center text-gray-300">
            Signup{" "} 
            <span className="text-blue-500">SudoSocialize</span>
            </h1>
            <form onSubmit={handleSubmit}>
                ...
                <label className="label p-2">
                    ...
                    <input type="text" placeholder="Sarvesh" value={inputs.fullName} className="w-full input input-bordered h-10"
                ...
                <label className="label p-2">
                    ...
                    <input type="text" placeholder="sarvesh50" className="w-full input input-bordered h-10"
